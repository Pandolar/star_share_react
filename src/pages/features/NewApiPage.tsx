        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-xl p-8 shadow-md">
            ...
            <ul className="space-y-2 mb-6">
              <li className="bg-gray-100 p-3 rounded font-mono text-sm">https://nicerouter.com</li>
              <li className="bg-gray-100 p-3 rounded font-mono text-sm">https://nicerouter.com/v1</li>
              <li className="bg-gray-100 p-3 rounded font-mono text-sm">https://nicerouter.com/v1/chat/completions</li>
            </ul>
