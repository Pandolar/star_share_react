...
const NewApiPage: React.FC = () => {
  return (
    <div className="bg-default-50 text-default-800 font-sans">
      {/* How to use */}
      <section id="how-to-use" className="py-16 bg-default-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center text-default-800">如何使用？</h2>
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-xl p-8 shadow-md">
            ...
            <div className="bg-default-900 text-green-400 p-4 rounded-lg font-mono text-sm mb-6 overflow-x-auto">
              https://nicerouter.com 对应 https://api.openai.com
            </div>

            <p className="text-lg mb-4 text-default-700">
              不同的客户端需要填写不同的 BASE_URL，这些都可以试一下：
            </p>
            <ul className="space-y-2 mb-6">
              <li className="bg-default-100 p-3 rounded font-mono text-sm">https://nicerouter.com</li>
              <li className="bg-default-100 p-3 rounded font-mono text-sm">https://nicerouter.com/v1</li>
              <li className="bg-default-100 p-3 rounded font-mono text-sm">https://nicerouter.com/v1/chat/completions</li>
            </ul>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-blue-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h2 className="text-2xl font-bold mb-4 text-default-800">企业用户</h2>
            ...
            <div className="bg-indigo-50 rounded-xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h2 className="text-2xl font-bold mb-4 text-default-800">个人创作者</h2>
              <ul className="space-y-3 text-default-600">
                <li className="flex items-start">
                  <CheckCircleIcon className="w-5 h-5 text-green-500 mt-1 mr-3 flex-shrink-0" />
      ...
      <section id="features" className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center text-default-800">为什么选择我们？</h2>

          <p className="text-center text-default-600 max-w-3xl mx-auto mb-12">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-default-100">
                  <th className="py-4 px-6 font-bold text-default-700">对比项</th>
                  <th className="py-4 px-6 font-bold text-blue-600">NiceAIGC API</th>
                  <th className="py-4 px-6 font-bold text-default-600">官方</th>
                </tr>
              </thead>
      ...
      <section className="py-16 bg-default-50">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold mb-12 text-center text-default-800">API用途</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">用于翻译</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">辅助写作</h3>
              <p className="text-default-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">代码顾问</h3>
              <p className="text-default-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">多客户端支持</h3>
              <p className="text-default-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">自定义助手</h3>
              <p className="text-default-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold mb-3 text-default-800">文档理解</h3>
              <p className="text-default-600">
