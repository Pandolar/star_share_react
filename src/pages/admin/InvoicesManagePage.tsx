        ...
        <TableBody emptyContent="没有符合条件的开票订单" isLoading={loading} loadingContent={<Spinner />}>
          {rows.map((record) => (
            <TableRow key={record.id}>
              ...
              <TableCell><div className="text-sm"><p>实付 ¥{record.paid_amount || record.payable_amount}</p><p className="text-default-500">基础 ¥{record.base_amount} + 服务费 ¥{record.surcharge_amount}</p></div></TableCell>
